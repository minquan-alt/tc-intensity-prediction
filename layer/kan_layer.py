...
class KANLinear(nn.Module):  # grid_size=5,
    """
    Reference: A multivariate time series prediction model based on the KAN network
    https://www.nature.com/articles/s41598-025-07654-7#Equ2
    """
